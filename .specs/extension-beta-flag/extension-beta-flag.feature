Feature: CORE019_Extension_Beta_Flag
  ...
  # @feature3
  Scenario: CORE019_08 updater updates already-installed beta
    Given beta extension was previously installed explicitly
    When updater runs and beta extension has new version
    Then beta extension SHALL be updated
