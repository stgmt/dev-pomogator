# Ownership Recommendation — extension-beta-flag
...
- **Canonical owner (by proximity to first commit):** `extension-beta-flag`
...
2. Update cross-references to point to `extension-beta-flag` module.
