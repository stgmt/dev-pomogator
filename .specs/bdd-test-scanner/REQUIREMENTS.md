...
|----|------|-----------|-----------|--------|
| [FR-1](FR.md#fr-1-scan-existing-non-bdd-tests-at-session-start) | Scan existing non-BDD tests at session start | [AC-1](ACCEPTANCE_CRITERIA.md#ac-1-fr-1) | @feature1 | Draft |
| [FR-2](FR.md#fr-2-shared-non-bdd-test-detector) | Shared non-BDD test detector | [AC-2](ACCEPTANCE_CRITERIA.md#ac-2-fr-2) | @feature2 | Draft |
| [FR-3](FR.md#fr-3-advisory-two-path-notice) | Advisory two-path notice | [AC-3](ACCEPTANCE_CRITERIA.md#ac-3-fr-3) | @feature3 | Draft |
| [FR-4](FR.md#fr-4-a-tracking-issue-gates-the-notice) | A tracking issue gates the notice | [AC-4](ACCEPTANCE_CRITERIA.md#ac-4-fr-4) | @feature4 | Draft |
| [FR-5](FR.md#fr-5-plugin-wide-distribution) | Plugin-wide distribution | [AC-5](ACCEPTANCE_CRITERIA.md#ac-5-fr-5) | @feature5 | Draft |
| [FR-6](FR.md#fr-6-doctor-verifies-and-repairs-the-hook-and-its-dependencies) | Doctor verifies and repairs the hook and its dependencies | [AC-6](ACCEPTANCE_CRITERIA.md#ac-6-fr-6) | @feature6 | Draft |
...
| CHK-FR3-01 | FR-3 covered by AC-3 via @feature3 | FR-3, AC-3, @feature3 | BDD scenario | Draft | — |
| CHK-FR4-01 | FR-4 covered by AC-4 via @feature4 | FR-4, AC-4, @feature4 | BDD scenario | Draft | — |
| CHK-FR5-01 | FR-5 covered by AC-5 via @feature5 | FR-5, AC-5, @feature5 | BDD scenario | Draft | — |
| CHK-FR6-01 | FR-6 covered by AC-6 via @feature6 | FR-6, AC-6, @feature6 | BDD scenario | Draft | — |
