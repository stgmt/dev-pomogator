...
**Связанные AC:** [AC-1](ACCEPTANCE_CRITERIA.md#ac-1-fr-1-compactbar-рендеринг-feature1)
**Use Case:** [UC-1](USE_CASES.md#uc-1-compact-mode-показывает-прогресс-тестов-feature1)
...
**Связанные AC:** [AC-2](ACCEPTANCE_CRITERIA.md#ac-2-fr-2-toggle-compactfull-feature2)
**Use Case:** [UC-2](USE_CASES.md#uc-2-переключение-compact-full-feature2)
...
**Связанные AC:** [AC-3](ACCEPTANCE_CRITERIA.md#ac-3-fr-3-stop-tests-feature3)
**Use Case:** [UC-3](USE_CASES.md#uc-3-stop-tests-из-tui-feature3)
...
**Связанные AC:** [AC-4](ACCEPTANCE_CRITERIA.md#ac-4-fr-4-auto-compact-feature4)
**Use Case:** [UC-4](USE_CASES.md#uc-4-auto-compact-при-маленьком-терминале-feature4)
...
**Связанные AC:** [AC-5](ACCEPTANCE_CRITERIA.md#ac-5-fr-5-выпиливание-statusline-feature5)
**Use Case:** [UC-5](USE_CASES.md#uc-5-выпиливание-statusline-render-feature5)
...
**Связанные AC:** [AC-6](ACCEPTANCE_CRITERIA.md#ac-6-fr-6-idle-indicator-feature1)
...
**Связанные AC:** [AC-7](ACCEPTANCE_CRITERIA.md#ac-7-fr-7-docker-session-propagation-feature14)
...
**Связанные AC:** [AC-8](ACCEPTANCE_CRITERIA.md#ac-8-fr-8-dual-directory-yaml-reader-feature15)
...
**Связанные AC:** [AC-9](ACCEPTANCE_CRITERIA.md#ac-9-fr-9-tui-stop-hook-feature16)
...
**Связанные AC:** [AC-10](ACCEPTANCE_CRITERIA.md#ac-10-fr-10-docker-session-passing-feature14)
