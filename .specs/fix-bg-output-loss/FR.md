...
**Связанные AC:** [AC-1](ACCEPTANCE_CRITERIA.md#ac-1-fr-1), [AC-2](ACCEPTANCE_CRITERIA.md#ac-2-fr-1)
...
**Связанные AC:** [AC-10](ACCEPTANCE_CRITERIA.md#ac-10-fr-10-cleanup-duplicate-verified)
...
**Связанные AC:** [AC-11](ACCEPTANCE_CRITERIA.md#ac-11-fr-11-generic-adapter-integration)
...
**Связанные AC:** [AC-12](ACCEPTANCE_CRITERIA.md#ac-12-fr-12-smart-converter-deny-message)
...
**Связанные AC:** [AC-13](ACCEPTANCE_CRITERIA.md#ac-13-fr-13-skillmd-description-improvements)
...
**Связанные AC:** [AC-14](ACCEPTANCE_CRITERIA.md#ac-14-fr-14-analysis-report-saved)
...
**Связанные AC:** [AC-15](ACCEPTANCE_CRITERIA.md#ac-15-fr-15-benchmark-report-saved)
...
**Связанные AC:** [AC-16](ACCEPTANCE_CRITERIA.md#ac-16-fr-16-conditional-installer-hook-path-bug) (conditional → NOT APPLICABLE)
...
**Связанные AC:** [AC-17](ACCEPTANCE_CRITERIA.md#ac-17-fr-17-windows-path-mangling-fix) Если usage data покажет несоблюдение FR-7/FR-8 — создать отдельный spec `bg-pipe-guard-hook` с PreToolUse Bash matcher (mirror pattern `extensions/scope-gate/` + `extensions/reqnroll-ce-guard/`).
