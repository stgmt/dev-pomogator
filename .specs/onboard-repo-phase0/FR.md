...
**Связанные AC:** [AC-1](ACCEPTANCE_CRITERIA.md#ac-1-fr-1-auto-trigger-phase-0-feature1) · **Use Case:** [UC-1](USE_CASES.md#uc-1-первый-create-spec-в-новом-репо-auto-trigger-phase-0-feature1)
...
**Связанные AC:** [AC-2](ACCEPTANCE_CRITERIA.md#ac-2-fr-2-onboardingjson-schema-feature2-feature10) · **Use Case:** [UC-1](USE_CASES.md#uc-1-первый-create-spec-в-новом-репо-auto-trigger-phase-0-feature1), [UC-2](USE_CASES.md#uc-2-последующий-create-spec-с-валидным-cache-feature4)
...
**Связанные AC:** [AC-3](ACCEPTANCE_CRITERIA.md#ac-3-fr-3-pretooluse-hook-compile-feature3) · **Use Case:** [UC-9](USE_CASES.md#uc-9-рендеринг-в-dual-artifact-после-text-gate-feature15)
...
**Связанные AC:** [AC-4](ACCEPTANCE_CRITERIA.md#ac-4-fr-4-git-sha-cache-invalidation-feature4) · **Use Case:** [UC-2](USE_CASES.md#uc-2-последующий-create-spec-с-валидным-cache-feature4), [UC-3](USE_CASES.md#uc-3-git-sha-изменился-prompt-refresh-feature4), [UC-4](USE_CASES.md#uc-4-manual-refresh-через-refresh-onboarding-feature4)
...
**Связанные AC:** [AC-5](ACCEPTANCE_CRITERIA.md#ac-5-fr-5-baseline-test-run-feature5) · **Use Case:** [UC-7](USE_CASES.md#uc-7-repo-без-тестов-feature5), [UC-13](USE_CASES.md#uc-13-partial-onboarding-skip-baseline-tests-feature5)
...
**Связанные AC:** [AC-6](ACCEPTANCE_CRITERIA.md#ac-6-fr-6-text-gate-feature6) · **Use Case:** [UC-8](USE_CASES.md#uc-8-text-gate-не-пройден-итеративное-уточнение-feature6)
...
**Связанные AC:** [AC-7](ACCEPTANCE_CRITERIA.md#ac-7-fr-7-parallel-subagents-feature7) · **Use Case:** [UC-11](USE_CASES.md#uc-11-scratch-file-при-крупном-repo-feature14)
...
**Связанные AC:** [AC-8](ACCEPTANCE_CRITERIA.md#ac-8-fr-8-archetype-triage-feature8) · **Use Case:** [UC-12](USE_CASES.md#uc-12-archetype-routing-frontend-spa-feature8)
...
**Связанные AC:** [AC-9](ACCEPTANCE_CRITERIA.md#ac-9-fr-9-onboardingmd-prose-report-feature9) · **Use Case:** Поддерживает US-11 (new team member)
...
**Связанные AC:** [AC-10](ACCEPTANCE_CRITERIA.md#ac-10-fr-10-ai-specific-sections-mandatory-feature10) · **Memory trigger:** [Onboarding artifact AI-centric](../../../memory/feedback_onboarding-artifact-must-be-ai-centric.md)
...
**Связанные AC:** [AC-11](ACCEPTANCE_CRITERIA.md#ac-11-fr-11-developer-onboarding-checklist-feature11) · **Use Case:** Поддерживает US-11
...
**Связанные AC:** [AC-12](ACCEPTANCE_CRITERIA.md#ac-12-fr-12-coexistence-с-init-feature12) · **Use Case:** [UC-10](USE_CASES.md#uc-10-coexistence-с-anthropic-init-feature12)
...
**Связанные AC:** [AC-13](ACCEPTANCE_CRITERIA.md#ac-13-fr-13-delivered-as-extension-feature13) · **Use Case:** [UC-5](USE_CASES.md#uc-5-target-repo-не-имеет-установленного-dev-pomogator-feature13)
...
**Связанные AC:** [AC-14](ACCEPTANCE_CRITERIA.md#ac-14-fr-14-scratch-file-feature14) · **Use Case:** [UC-11](USE_CASES.md#uc-11-scratch-file-при-крупном-repo-feature14)
...
**Связанные AC:** [AC-15](ACCEPTANCE_CRITERIA.md#ac-15-fr-15-dual-render-feature15) · **Use Case:** [UC-9](USE_CASES.md#uc-9-рендеринг-в-dual-artifact-после-text-gate-feature15)
...
**Связанные AC:** [AC-16](ACCEPTANCE_CRITERIA.md#ac-16-fr-16-manual-refresh-feature4) · **Use Case:** [UC-4](USE_CASES.md#uc-4-manual-refresh-через-refresh-onboarding-feature4)
...
**Связанные AC:** [AC-17](ACCEPTANCE_CRITERIA.md#ac-17-fr-17-ignore-files-respect-feature2) · **Use Case:** [EC-3](USE_CASES.md#ec-3-cursorignore--aiderignore-в-репо)
...
**Связанные AC:** [AC-18](ACCEPTANCE_CRITERIA.md#ac-18-fr-18-commands-via-skill-reference-feature3-feature15) · **Memory trigger:** [Onboarding artifact AI-centric](../../../memory/feedback_onboarding-artifact-must-be-ai-centric.md)
...
**Связанные AC:** [AC-19](ACCEPTANCE_CRITERIA.md#ac-19-fr-19-sha-256-managed-tracking)
...
**Связанные AC:** [AC-20](ACCEPTANCE_CRITERIA.md#ac-20-fr-20-json-schema-validation)
