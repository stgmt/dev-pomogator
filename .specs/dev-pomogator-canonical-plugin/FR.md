...
Spec-conformance routes SHALL additionally satisfy [spec-generator-v4 FR-83](../spec-generator-v4/FR.md#fr-83): no-spec projects are state-free no-ops and the per-project journal uses 10 MiB rotation, 64 MiB total retention, 30-day closed-shard expiry, and a 1 GiB free-space reserve.
...
## FR-15: Managed hot-path hooks are HTTP registrations
