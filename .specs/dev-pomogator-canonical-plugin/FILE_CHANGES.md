...
| `tools/migrate-v1-to-v2/migrate-v1-to-v2.ts` | edit | [FR-7](FR.md#fr-7-migration-v1-v2-documentation-optional-cleanup-script) — standalone cleanup script для users переходящих с v1; shipped v2.0, ongoing maintenance |
...
| `tests/e2e/canonical-plugin.test.ts` | edit | Drift test для AC-1, FR-9: каждая hooks.json команда резолвится в on-disk скрипт под `tools/` (и vice-versa) + manifest schema validity; shipped 2026-05-27, ongoing maintenance |
