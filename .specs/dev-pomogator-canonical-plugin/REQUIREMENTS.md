...
| CHK-ID | Requirement | Traces To (FR+SC) | Verification Method | Status | Notes |
|---|---|---|---|---|---|
| CHK-FR13-20 | Installed requests separate plugin code root from caller project root | [FR-13](FR.md#fr-13-plugin-hooks-use-one-authenticated-loopback-service), [AC-12](ACCEPTANCE_CRITERIA.md#ac-12-installed-hook-project-isolation-and-bounded-conformance-state), CORE024_20 | BDD scenario | Draft | Cross-links spec-generator-v4 FR-83 / SPECGEN004_715–721 |
