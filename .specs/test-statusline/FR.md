...
**Связанные AC:** [AC-1](ACCEPTANCE_CRITERIA.md#ac-1-fr-1-statusline-render-output-feature1)
...
**Связанные AC:** [AC-1a](ACCEPTANCE_CRITERIA.md#ac-1a-fr-1a-graceful-degradation-feature1a)
**Use Case:** [UC-1](USE_CASES.md#uc-1-отображение-прогресса-запущенных-тестов-feature1)
...
**Связанные AC:** [AC-2](ACCEPTANCE_CRITERIA.md#ac-2-fr-2-yaml-status-file-format-feature2)
...
**Связанные AC:** [AC-3](ACCEPTANCE_CRITERIA.md#ac-3-fr-3-atomic-yaml-writes-feature2)
**Use Case:** [UC-4](USE_CASES.md#uc-4-test-runner-wrapper-записывает-прогресс-feature2)
...
**Связанные AC:** [AC-4](ACCEPTANCE_CRITERIA.md#ac-4-fr-4-test-runner-wrapper-feature2)
**Use Case:** [UC-4](USE_CASES.md#uc-4-test-runner-wrapper-записывает-прогресс-feature2)
...
**Связанные AC:** [AC-5](ACCEPTANCE_CRITERIA.md#ac-5-fr-5-session-isolation-feature3)
...
**Связанные AC:** [AC-6](ACCEPTANCE_CRITERIA.md#ac-6-fr-6-session-start-hook-feature4)
**Use Case:** [UC-2](USE_CASES.md#uc-2-инициализация-сессии-и-cleanup-feature4)
...
**Связанные AC:** [AC-7](ACCEPTANCE_CRITERIA.md#ac-7-fr-7-stale-session-cleanup-feature4)
**Use Case:** [UC-2](USE_CASES.md#uc-2-инициализация-сессии-и-cleanup-feature4)
...
**Связанные AC:** [AC-8](ACCEPTANCE_CRITERIA.md#ac-8-fr-8-extension-manifest-feature5)
...
**Связанные AC:** [AC-9](ACCEPTANCE_CRITERIA.md#ac-9-fr-9-docker-test-isolation-feature6)
**Use Case:** [UC-3](USE_CASES.md#uc-3-параллельные-сессии-claude-code-feature3)
...
**Связанные AC:** [AC-10](ACCEPTANCE_CRITERIA.md#ac-10-fr-10-hooks-integrity-guard-feature7)
