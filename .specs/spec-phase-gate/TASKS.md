...
- [x] create-bdd-feature-file @feature1 @feature2 @feature3 @feature4
  **description:**
...
- [x] create-phase-constants @feature1
  **description:**
...
- [x] refactor-validate-specs-imports @feature2
  **description:**
...
> Добавить 4 новых check в audit-checks.ts: PARTIAL_IMPL, TASK_ATOMICITY, FR_SPLIT_CONSISTENCY, AC_SCOPE_MATCH.
> После реализации: 5 сценариев @feature3 переходят из Red в Green.

- [x] add-partial-impl-check @feature3
  **description:**
    Добавить CHECK-9 (PARTIAL_IMPL) в `audit-checks.ts`:
...
- [x] add-task-atomicity-check @feature3
  **description:**
    Добавить CHECK-10 (TASK_ATOMICITY) в `audit-checks.ts`:
...
- [x] add-fr-split-and-ac-scope-checks @feature3
  **description:**
    Добавить CHECK-11 (FR_SPLIT_CONSISTENCY) и CHECK-12 (AC_SCOPE_MATCH) в `audit-checks.ts`:
...
- [x] add-rules-to-specs-management @feature4
  **description:**
    Добавить 3 новых правила в `.claude/skills/create-spec/references/specs-validation.md`:
...
- [x] update-extension-manifest-final
  **description:**
