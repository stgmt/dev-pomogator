...
**Связанные AC:** [AC-1](ACCEPTANCE_CRITERIA.md#ac-1-fr-1-capture-hook-script-feature1)
**Use Case:** [UC-1](USE_CASES.md#uc-1-автозахват-коррекции-пользователя-happy-path-feature1), [UC-2](USE_CASES.md#uc-2-захват-при-завершении-сессии-feature1)
...
**Связанные AC:** [AC-1a](ACCEPTANCE_CRITERIA.md#ac-1a-fr-1a-regex-based-detection-feature1a)
...
**Связанные AC:** [AC-1b](ACCEPTANCE_CRITERIA.md#ac-1b-fr-1b-ai-powered-semantic-detection-feature1b)
...
**Связанные AC:** [AC-2](ACCEPTANCE_CRITERIA.md#ac-2-fr-2-queue-schema-feature2)
...
**Связанные AC:** [AC-3](ACCEPTANCE_CRITERIA.md#ac-3-fr-3-atomic-queue-operations-feature3)
**Use Case:** [UC-1](USE_CASES.md#uc-1-автозахват-коррекции-пользователя-happy-path-feature1)
...
**Связанные AC:** [AC-4](ACCEPTANCE_CRITERIA.md#ac-4-fr-4-suggest-rules-phase-15-integration-feature4)
**Use Case:** [UC-3](USE_CASES.md#uc-3-suggest-rules-потребляет-очередь-feature3)
...
**Use Case:** [UC-5](USE_CASES.md#uc-5-auto-dedupe-при-suggest-rules-feature3)
...
**Связанные AC:** [AC-6](ACCEPTANCE_CRITERIA.md#ac-6-fr-6-reflect-command-feature2)
**Use Case:** [UC-4](USE_CASES.md#uc-4-reflect-быстрый-просмотр-очереди-feature2)
...
**Связанные AC:** [AC-8](ACCEPTANCE_CRITERIA.md#ac-8-fr-8-extension-manifest-update-feature4)
...
**Связанные AC:** [AC-9](ACCEPTANCE_CRITERIA.md#ac-9-fr-9-installation-verification-feature4)
