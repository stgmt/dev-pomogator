...
**Use Case:** [UC-1](USE_CASES.md#uc-1-агент-молча-предотвращает-жаргонный-ответ-happy-path-для-us-1-feature1)
...
**Use Case:** [UC-2](USE_CASES.md#uc-2-пользователь-явно-вызывает-answer-simple-для-аудита-черновика-happy-path-для-us-2-feature2)
...
**Use Case:** [UC-4](USE_CASES.md#uc-4-установка-extension-в-target-проект-через-installer-happy-path-для-us-3-feature3)
...
**Use Case:** [UC-3](USE_CASES.md#uc-3-триггер-инцидента-пользователь-говорит-не-понял-edge-case-для-us-1-feature1)
...
**Use Case:** [UC-1](USE_CASES.md#uc-1-агент-молча-предотвращает-жаргонный-ответ-happy-path-для-us-1-feature1), [UC-2](USE_CASES.md#uc-2-пользователь-явно-вызывает-answer-simple-для-аудита-черновика-happy-path-для-us-2-feature2)
