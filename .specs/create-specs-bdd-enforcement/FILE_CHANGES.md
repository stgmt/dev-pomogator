...
| `extensions/specs-workflow/tools/specs-generator/specs-generator-core.mjs` | edit | [FR-1](FR.md#fr-1-phase-2-step-6-extends-с-testformat-classification-feature1), [FR-3](FR.md#fr-3-analyze-featurests-multi-folder-recursive-scan-feature3), [FR-5](FR.md#fr-5-state-machine-гейтит-requirementsfinalization-на-bdd-classification-feature5), [FR-7](FR.md#fr-7-validator-bddinfra-rule-severity-upgrade-warning-error-feature7) — createDefaultProgressState новые поля, Requirements→Finalization gate, BDD_INFRA severity ERROR, multi-folder analyze-features, ConfirmStop pre-check |
...
| `extensions/specs-workflow/tools/specs-generator/templates/DESIGN.md.template` | edit | [FR-1](FR.md#fr-1-phase-2-step-6-extends-с-testformat-classification-feature1) — новые поля TEST_FORMAT, Framework, Install Command, Evidence |
...
| `.claude/skills/create-spec/references/bdd-enforcement.md` | create | [FR-1](FR.md#fr-1-phase-2-step-6-extends-с-testformat-classification-feature1), [FR-2](FR.md#fr-2-phase-15-project-context-детектит-bdd-framework-в-target-test-projects-feature2), [FR-6](FR.md#fr-6-tasksmd-phase-0-bootstrap-block-install-hooks-fixtures-config-feature6), [FR-9](FR.md#fr-9-создание-спеки-specscreate-specs-bdd-enforcement-с-cross-reference-на-spec-phase-gate-feature9) — правило «BDD is default» + framework decision tree + Phase 1.5/2 hooks. **Архитектурный сдвиг:** изначально планировались 4 файла-зеркала в `.claude/rules/specs-workflow/` и `extensions/specs-workflow/rules/claude/` (по 2 для specs-management + 2 для bdd-enforcement). Реально — один консолидированный `bdd-enforcement.md` живёт внутри `create-spec` skill bundle, где его use-site (workflow) и определение находятся вместе. |
| `.claude/skills/create-spec/references/specs-validation.md` | edit | [FR-7](FR.md#fr-7-validator-bddinfra-rule-severity-upgrade-warning-error-feature7) — описание BDD_INFRA_CLASSIFICATION_COMPLETE rule (severity ERROR). Изначально планировалось как `.claude/rules/specs-workflow/specs-validation.md` + mirror — переместилось в skill references. |
