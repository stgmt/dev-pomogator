...
### NFR-Legacy-1: Soft-tier hook chain latency
...
### NFR-Legacy-2: Audit log append latency
...
### NFR-Legacy-3: Audit log retention and rotation
...
### NFR-Legacy-4: Hook fail-open safety invariant
...
### NFR-Legacy-5: UserPromptSubmit summary latency (v3 behavior)
...
### NFR-Legacy-6: Backward-compat for `.progress.json::version` reads
