...
|----|-------|--------|---------|-------|------|
| install-bdd-framework | Install cucumber-js + messages packages | TODO | — | Phase 0 | 20m |
| bootstrap-bdd-hooks | Scaffold tests/hooks/before-after.ts | TODO | install-bdd-framework | Phase 0 | 30m |
| bootstrap-bdd-fixtures-config | Create cucumber.json + fixtures | TODO | bootstrap-bdd-hooks | Phase 0 | 45m |
| migrate-vitest-bdd-pseudo | Convert vitest pseudo-BDD → cucumber-js | TODO | bootstrap-bdd-fixtures-config | Phase 0 | 240m |
| verify-phase0-red | Verify all 37 scenarios FAIL | TODO | migrate-vitest-bdd-pseudo | Phase 0 | 30m |
...
- [ ] Install cucumber-js packages -- @feature1 — id: install-bdd-framework — Status: TODO | Est: 20m
...
- [ ] Bootstrap hooks tests/hooks/before-after.ts -- @feature1 — id: bootstrap-bdd-hooks — Status: TODO | Est: 30m
...
- [ ] Create cucumber.json + tests/fixtures/v4-self-test/ -- @feature1 — id: bootstrap-bdd-fixtures-config — Status: TODO | Est: 45m
...
- [ ] Migrate vitest pseudo-BDD → cucumber-js step defs -- @feature1 — id: migrate-vitest-bdd-pseudo — Status: TODO | Est: 240m
...
- [ ] Verify Phase 0 — all 37 scenarios FAIL (Red) -- @feature1 — id: verify-phase0-red — Status: TODO | Est: 30m
