...
- [x] P13-2: edges use composite keys + build the @featureN tested-by layer -- @feature36 — id: p13-edges-featureN — Status: DONE (2026-06-06; Docker-подтверждение clean-worktree прогоном — см. ниже) | Est: 240m
