...
| T0-05 | Verify Phase 0 | DONE | migrate-vitest-bdd-pseudo | Phase 0: BDD Foundation (Red) — Cucumber-JS migration | 30m |
...
| T4-30 | SQLite index opt-in -- @feature10 | DONE | graph-builder-impl | Phase 4: SQLite + side-channel log + Codespaces (Green) | 360m |
...
| T5-38 | Heading converter -- @feature11 | DONE | migrate-script-main | Phase 5: Migration helper v3→v4 (Green) | 180m |
...
- [x] T-Trans.17 5-shape fixture corpus + integration test — id: fixture-shapes-corpus — Status: DONE | Est: 240m
