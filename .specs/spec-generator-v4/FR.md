...
**Авто-сёрфинг честного статуса + анти-false-close: гибрид (баннер несёт следующий шаг + census-aware стоп-гейт + освежение кэша на смене статуса + сверщик устаревших маркеров)**
