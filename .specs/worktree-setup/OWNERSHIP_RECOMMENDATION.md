# Ownership Recommendation — worktree-setup
...
- **worktree-setup created:** 2026-05-22
- **Canonical owner (by proximity to first commit):** `worktree-setup`
...
2. Update cross-references to point to `worktree-setup` module.
