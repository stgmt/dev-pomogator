...
- **Two-Stage Plan Presentation Workflow** — AI показывает summary перед планом; явная команда `делай план` уже подтверждает scope, поэтому AI сразу пишет и валидирует файл без повторного вопроса
