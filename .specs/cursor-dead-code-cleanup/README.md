...
Удаление ~505 строк мёртвого Cursor-кода из ~~`src/installer/memory.ts`~~ (removed in v2 — no canonical replacement) и ~~`src/updater/index.ts`~~ (removed in v2 migration).
