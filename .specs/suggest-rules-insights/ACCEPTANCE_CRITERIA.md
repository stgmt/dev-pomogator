...
**Требование:** [FR-1: Чтение отчёта insights](FR.md#fr-1-чтение-отчёта-insights-feature1)
...
**Требование:** [FR-2: Проверка свежести отчёта](FR.md#fr-2-проверка-свежести-отчёта-feature2)
...
**Требование:** [FR-3: Извлечение friction categories](FR.md#fr-3-извлечение-friction-categories-feature3)
...
**Требование:** [FR-4: Извлечение CLAUDE.md suggestions](FR.md#fr-4-извлечение-claudemd-suggestions-feature4)
...
**Требование:** [FR-7: Создание pre-candidates с оценкой релевантности](FR.md#fr-7-создание-pre-candidates-с-оценкой-релевантности-feature7)
...
**Требование:** [FR-8: Unified mode display](FR.md#fr-8-unified-mode-display-feature8)
...
**Требование:** [FR-9: Маркер источника в Phase 3](FR.md#fr-9-маркер-источника-в-phase-3-feature9)
...
**Требование:** [FR-10: Дедупликация insights с session findings](FR.md#fr-10-дедупликация-insights-с-session-findings-feature9)
...
**Требование:** Cross-cutting -- покрывает [FR-1](FR.md#fr-1-чтение-отчёта-insights-feature1) через [FR-9](FR.md#fr-9-маркер-источника-в-phase-3-feature9)
