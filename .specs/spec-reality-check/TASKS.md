...
- [ ] Создать 5 fixture spec директорий в `tests/fixtures/spec-reality-check/` -- @feature10 — id: t01 — Status: TODO | Est: 30m
...
- [ ] Создать `tests/e2e/spec-reality-check.test.ts` с test stubs SRC001_01..10 (all RED) -- @feature10 — id: t02 — Status: TODO | Est: 45m
  _Requirements: [FR-10](FR.md#fr-10-test-coverage-feature10)_
...
- [ ] Создать `tests/e2e/spec-reality-check-hook.test.ts` с test stubs SRCHOOK001_01..03 (all RED) -- @feature10 — id: t03 — Status: TODO | Est: 30m
  _Requirements: [FR-10](FR.md#fr-10-test-coverage-feature10)_
  **Done When:**
...
- [ ] Реализовать `verify.ts` shell: AuditFinding import, FILE_CHANGES parser с graceful fallback, CLI args -- @feature1 @feature2 @feature14 — id: t04 — Status: TODO | Est: 60m
...
- [ ] Добавить 3 FC checks в verify.ts -- @feature2 — id: t05 — Status: TODO | Est: 45m
...
- [ ] Добавить narrative path check -- @feature3 — id: t06 — Status: TODO | Est: 45m
...
- [ ] Добавить 3 output formats -- @feature6 — id: t07 — Status: TODO | Est: 45m
...
- [ ] Добавить code-drift check через git log -- @feature4 — id: t08 — Status: TODO | Est: 45m
...
- [ ] Добавить TASKS↔FC consistency check -- @feature5 — id: t09 — Status: TODO | Est: 30m
...
- [ ] Negative test verification — verify.ts на shipped clean spec → 0 ERRORs -- @feature10 — id: t10 — Status: TODO | Est: 15m
  _Requirements: [FR-10](FR.md#fr-10-test-coverage-feature10)_
  **Done When:**
...
- [ ] Реализовать verify-hook.ts -- @feature7 @feature8 — id: t11 — Status: TODO | Est: 60m
...
- [ ] Создать SKILL.md с auto-trigger description -- @feature1 — id: t12 — Status: TODO | Est: 30m
...
- [ ] Добавить skill + hook в extension.json -- @feature9 — id: t13 — Status: TODO | Est: 30m
...
- [ ] Создать installed copies в `.dev-pomogator/tools/spec-reality-check/` -- @feature9 — id: t14 — Status: TODO | Est: 10m
  _Requirements: [FR-9](FR.md#fr-9-extension-manifest-wiring-feature9)_
  **Done When:**
  - [ ] verify.ts copied
  - [ ] verify-hook.ts copied

- [ ] Интегрировать в spec-review category 15 -- @feature12 — id: t15 — Status: TODO | Est: 45m
...
- [ ] Интегрировать в create-spec Phase 3 -- @feature13 — id: t16 — Status: TODO | Est: 30m
...
- [ ] Запустить skill на canonical-plugin spec -- @feature11 — id: t17 — Status: TODO | Est: 15m
...
- [ ] Починить drift в canonical-plugin spec docs -- @feature11 — id: t18 — Status: TODO | Est: 45m
  _Requirements: [FR-11](FR.md#fr-11-applied-on-canonical-plugin-spec-feature11)_
  **Done When:**
...
- [ ] Final verification — id: t19 — Status: TODO | Est: 30m
  **Done When:**
...
- [x] Bug fix в plan-gate.ts Phase 2.5 — string array → ValidationError objects -- @feature15 — id: t20 — Status: DONE | Est: 15m
