...
|--------|-------------|-------------------|---------------------|--------|-------|
| CHK-FR1-01 | Skill bundle layout via frontmatter | FR-1, AC-1, @feature1 | Manual review | Draft | Verify SKILL.md frontmatter в installed copy |
| CHK-FR2-01 | FC_CREATE_EXISTS check | FR-2, AC-2, @feature2 | BDD scenario | Draft | SRC001_01 |
| CHK-FR2-02 | FC_EDIT_MISSING check | FR-2, AC-2, @feature2 | BDD scenario | Draft | SRC001_02 |
| CHK-FR2-03 | FC_DELETE_MISSING check | FR-2, AC-2, @feature2 | BDD scenario | Draft | SRC001_03 |
| CHK-FR3-01 | Narrative path detection | FR-3, AC-3, @feature3 | BDD scenario | Draft | SRC001_04 |
| CHK-FR4-01 | Code-drift via git log | FR-4, AC-4, @feature4 | BDD scenario | Draft | SRC001_05 |
| CHK-FR4-02 | Skip if .git/ absent | FR-4, AC-4, @feature4 | Integration test | Draft | Edge case 3 |
| CHK-FR5-01 | TASKS↔FC orphan check | FR-5, AC-5, @feature5 | BDD scenario | Draft | SRC001_06 |
| CHK-FR6-01 | JSON format output | FR-6, AC-6, @feature6 | Unit test | Draft | — |
| CHK-FR6-02 | Human format output | FR-6, AC-6, @feature6 | Unit test | Draft | — |
| CHK-FR6-03 | Markdown format output | FR-6, AC-6, @feature6 | Unit test | Draft | — |
| CHK-FR7-01 | Hook deny on drift | FR-7, AC-7, @feature7 | BDD scenario | Draft | SRCHOOK001_01 |
| CHK-FR8-01 | Fail-open on exception | FR-8, AC-8, @feature8 | BDD scenario | Draft | SRCHOOK001_03 |
| CHK-FR9-01 | extension.json wiring | FR-9, AC-9, @feature9 | Manual review | Draft | Post-implementation |
| CHK-FR10-01 | Test suite green | FR-10, AC-10, @feature10 | Integration test | Draft | npm test после impl |
| CHK-FR11-01 | Canonical-plugin clean after fix | FR-11, AC-11, @feature11 | Manual review | Draft | Post-cleanup verification |
