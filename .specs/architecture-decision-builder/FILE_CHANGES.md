...
| `tools/specs-generator/architecture-decision/audit.ts` | edit | [FR-9](FR.md#fr-9-audit-category-architecture_coverage) + [FR-12](FR.md#fr-12-audit-category-completeness_coverage--completeness-ledger) — ARCHITECTURE + COMPLETENESS coverage (shipped) |
