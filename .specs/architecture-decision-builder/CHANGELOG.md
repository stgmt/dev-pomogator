...
### Added
- Спека architecture-decision-builder: 18 FR, 18 AC (EARS), 18 CHK, 9 Key Decisions, SCHEMA (PolicyId + Insight + policy_fit/correction_log/selected_policy + business_summary/scorecard/reality_check/cost_at_scale/time_costs/exit_cost/door_type/sensitivity), 21 BDD scenarios (@feature1..@feature21), 35 TASKS (TDD-порядок)
