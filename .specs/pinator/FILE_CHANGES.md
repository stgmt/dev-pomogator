...
| `tests/features/plugins/claim-evidence-gate/CEGATE001_pinator.feature` | edit | AC-1..AC-12 | Executable BDD (unchanged path this wave); contract mirror is `pinator.feature`. |
