...
- Key extensions: `plan-pomogator`, `specs-workflow`, `suggest-rules`, `test-statusline`, `tui-test-runner` (hybrid Python/Node.js TUI test runner), `bun-oom-guard` (auto-patches Bun runner to prevent OOM on Windows)
