...
item(type='dir|back' where=package.exists("WindowsTerminal") sep='bottom' title='Claude Code' image='@app.dir\\imports\\claude-icon.ico' cmd='wt.exe' args='-d "@sel.dir\\." -- cmd /k claude')
`;
}
