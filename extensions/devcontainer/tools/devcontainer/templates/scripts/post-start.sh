...
sudo ln -sf "{{WORKSPACE_FOLDER}}/.devcontainer/scripts/open-browser.sh" /usr/local/bin/open-browser 2>/dev/null || true
...
CLAUDE_MEM_DEEP="/home/vscode/.claude/projects/-workspaces-{{PROJECT_NAME}}/memory"
CLAUDE_MEM_REPO="{{WORKSPACE_FOLDER}}/.claude/memory"
