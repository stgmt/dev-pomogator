...
- **Путь:** `.cursor/rules/antipatterns/no-direct-prod-db.mdc`
...
| Тип | Путь |
|-----|------|
| 🔴 antipattern | `.cursor/rules/antipatterns/<name>.mdc` |
| 🟢 pattern | `.cursor/rules/patterns/<name>.mdc` |
| 📋 checklist | `.cursor/rules/checklists/<name>.mdc` |
| ⚠️ gotcha | `.cursor/rules/gotchas/<name>.mdc` |
