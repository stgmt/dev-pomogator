...
export const TOOL_CONSUMERS: Readonly<Record<string, readonly string[]>> = {
  ...
  validate_requirement_metadata: ['spec-graph-query'],
  policy_query_requirements: ['spec-graph-query'],
  set_requirement_metadata: ['spec-graph-query'],
  list_phase_tasks: ['spec-graph-query'],
  list_tasks: ['spec-graph-query'],
  get_test_result: ['spec-graph-query'],
  get_scenario_trace: ['spec-graph-query'],
