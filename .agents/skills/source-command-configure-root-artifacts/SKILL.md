---
name: "source-command-configure-root-artifacts"
description: "Настроить whitelist файлов в корне репозитория"
---

# source-command-configure-root-artifacts

Use this skill when the user asks to run the migrated source command `configure-root-artifacts`.
