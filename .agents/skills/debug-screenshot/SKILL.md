...
```bash
powershell -ExecutionPolicy Bypass -File .Codex/skills/debug-screenshot/scripts/screenshot.ps1 -Label "description"
```
...
Screenshots are multimodal — Codex can see and analyze the image content.
...
```bash
powershell -ExecutionPolicy Bypass -File .Codex/skills/debug-screenshot/scripts/screenshot.ps1 -Label "after-wrapper-run"
```
