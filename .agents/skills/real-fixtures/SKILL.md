...
> `.Codex/rules/testing/verify-against-real-artifact.md`.
...
- Rule: `.Codex/rules/testing/verify-against-real-artifact.md` (real-time gate).
- Rule: `.Codex/rules/integration-tests-first.md`.
