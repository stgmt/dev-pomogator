...
- Detector tuning ("это false positive") — edit
  ...
  `.Codex/skills/cross-spec-reconcile/scripts/reconcile.ts` directly.
...
- `.Codex/skills/cross-spec-reconcile/SKILL.md` — the analyzer that
  produces findings (the input to this skill).
- `.Codex/skills/cross-spec-resolve/SKILL.md` — interactive walker for
