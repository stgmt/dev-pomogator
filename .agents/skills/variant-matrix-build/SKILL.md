...
Audit category VARIANT_COVERAGE downgrade severity to INFO для этого FR. Reason `<8 chars` triggers `WARNING_REASON_TOO_SHORT` finding (logged JSONL audit trail в `.Codex/logs/spec-variant-matrix-escapes.jsonl`).

## Related

- Trigger map rule: [.Codex/rules/specs-workflow/variant-matrix/when-to-build-matrix.md](../../../.Codex/rules/specs-workflow/variant-matrix/when-to-build-matrix.md)
- Escape hatch audit: [.Codex/rules/specs-workflow/variant-matrix/escape-hatch-audit.md](../../../.Codex/rules/specs-workflow/variant-matrix/escape-hatch-audit.md)
- Audit category reference: [.Codex/skills/create-spec/references/phase3plus_audit-variant-coverage.md](../../../.Codex/skills/create-spec/references/phase3plus_audit-variant-coverage.md)
- Adjacent skill (commit-time): [scope-gate verify-generic-scope-fix](../../../../scope-gate/.Codex/skills/verify-generic-scope-fix/SKILL.md)
- Plan-time fallback rule: [cross-scope-coverage.md](../../../.Codex/rules/plan-pomogator/cross-scope-coverage.md)
