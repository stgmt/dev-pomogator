...
See `.Codex/rules/.../feedback_verify-regressions-on-clean-checkout` memory + issue #45.
...
- `.Codex/skills/tests-create-update/SKILL.md` — how to WRITE tests that don't cause these
...
`.Codex/rules/spec-verdict/no-structural-valid.md` (FR-37d).
