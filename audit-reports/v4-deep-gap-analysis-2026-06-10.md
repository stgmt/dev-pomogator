...
1. **P21-1 multi-session door** (P0 — enforce без этого жизнеспособен только в
   одно-сессионном мире).
2. **P21-2 enforce-эргономика** (git-carve-out + пагинация read_spec_doc) — ежедневная
   боль, укушен в первый же час.
