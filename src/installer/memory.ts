...
let _installLogger: Logger | undefined;
 ...
 */
async function registerClaudeMemMcp(platform: 'claude'): Promise<void> {
 ...
 */
export async function ensureClaudeMem(platform: 'claude', logger?: Logger): Promise<ClaudeMemValidation> {
  ...
  const validation: ClaudeMemValidation = {
