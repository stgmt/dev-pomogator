...
| F-4 | `sample-tests/weak.test.ts` | WEAK assertion patterns (toBeDefined / toBeTruthy only) |
| F-5 | `sample-tests/strong.test.ts` | STRONG assertion patterns (toEqual + edge cases) |
| F-6 | `sample-tests/fake-positive.test.ts` | FAKE-POSITIVE-RISK patterns (vi.mock production + tautology) |
