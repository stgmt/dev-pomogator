...
Система ДОЛЖНА создавать структуру папки спецификации с 13 файлами при вызове scaffold-spec.sh.
...
Система ДОЛЖНА проверять структуру и форматы спецификации при вызове validate-spec.sh.
...
Система ДОЛЖНА показывать прогресс заполнения спецификации при вызове spec-status.sh.
